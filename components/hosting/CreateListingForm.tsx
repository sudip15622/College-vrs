  ...
  const onSubmit = async (data: CreateListingFormType) => {
    try {
      ...
      if (result.success) {
        ...
        // Redirect to listings page or the newly created listing
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="name"
                placeholder="e.g., Honda Activa 2023"
                {...register('name')}
              />
              {errors.name && (
          ...
          <div className="space-y-2">
            ...
            //   className="flex min-h-30 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring resize-none"
            />
            {errors.description && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Add special features and amenities</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upload a primary image of your vehicle</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {!imagePreview ? (
            <div className="space-y-2">
